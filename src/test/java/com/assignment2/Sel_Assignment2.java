...
@Test (dependsOnMethods = "test1", enabled = true)
  public void test2() throws InterruptedException {
	  ...
	  String[][] array = {{"Smith", "John", "jsmith@gmail.com", "$50.00"},{"Bach", "Frank", "fbach@yahoo.com", "$51.00"},{"Doe","Jason","jdoe@hotmail.com","$100.00"},{"Conway","Tim","tconway@earthlink.net","$50.00"}}; 
